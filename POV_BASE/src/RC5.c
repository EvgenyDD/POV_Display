...
/* Private define ------------------------------------------------------------*/
#if 0
#define   NOMINAL_HALF_BIT_TIME_US   889  /* Nominal half bit time in �s */
#define   MIN_HALF_BIT_TIME_US       640  /* Minimum half bit time in �s */
#define   MAX_HALF_BIT_TIME_US       1140 /* Maximum half bit time in �s */

#define   NOMINAL_FULL_BIT_TIME_US   1778 /* Nominal Full bit time in �s */
#define   MIN_FULL_BIT_TIME_US       1340 /* Minimum Full bit time in �s */
#define   MAX_FULL_BIT_TIME_US       2220 /* Maximum Full bit time in �s */
#else
#define   NOMINAL_HALF_BIT_TIME_US   800  /* Nominal half bit time in �s */
#define   MIN_HALF_BIT_TIME_US       640  /* Minimum half bit time in �s */
#define   MAX_HALF_BIT_TIME_US       1140 /* Maximum half bit time in �s */

#define   NOMINAL_FULL_BIT_TIME_US   1700 /* Nominal Full bit time in �s */
#define   MIN_FULL_BIT_TIME_US       1300 /* Minimum Full bit time in �s */
#define   MAX_FULL_BIT_TIME_US       2200 /* Maximum Full bit time in �s */
#endif
...
void EXTI4_15_IRQHandler()
{
	...
	if(EXTI_GetITStatus(EXTI_Line7) != RESET)
	{
		...
		else if(EdgesNumber == 2)
		{
			...
			/* If low duration is between 640�s*TimClk and 1140�s*TimClk (min and max half bit time) */
			...
			/* If low duration is between 1340�s*TimClk and 2220�s*TimClk (min and max full bit time)*/
